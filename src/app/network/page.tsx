...
export default function NetworkPage() {
  ...
  return (
    <AppShell>
      ...
      {/* Agent Details */}
      <div className="mt-12">
        <h2 className="font-display text-2xl font-semibold tracking-tight text-white mb-6">Agent Configuration</h2>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white/[0.03] rounded-xl border border-white/[0.06] p-4">
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div
                  key={skill}
                  className="px-2 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.06] text-white/60 text-[10px] font-mono"
                >
                  {skill}
                </div>
              ))}
        ...
        <div>
          ...
          <div className="bg-white/[0.03] rounded-xl border border-white/[0.06] p-4 space-y-2 text-xs">
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-white/70">HTTPS (Tunnel)</span>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white/[0.03] rounded-xl border border-white/[0.06] p-4 space-y-2 text-xs">
            ...
            <div className="mt-3 pt-3 border-t border-white/[0.06]">
              <p className="text-white/25 text-[10px]">
                OpenClaw v2026.2.6-3 • Node v22.22.0
              </p>
            </div>
          </div>
        </div>
      ...
      */}
      ...
      <div className="mt-12">
        ...
        {/* Workspace Display - Temporarily Disabled */}
